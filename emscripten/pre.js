...
Module['preInit'] = function() {
    ...
    try {
        ...
        FS.mount(IDBFS, { root: '.' }, '/home/web_user/.dink');
   } catch(e) {
       Module.print("Could not create ~/.dink/ and populate save files");
   }
...
Module['onRuntimeInitialized'] = function() {
    ...
    //loadChildScript('/freedink-data-data.js',
    ...
    if (_GET['dmod']) {
        ...
        try {
            dmoddiz = new TextDecoder().decode(FS.readFile('/usr/share/dink/dink/dmod.diz'), {encoding:'ISO-8859-1'});
