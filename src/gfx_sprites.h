...
much. */
//ye: bump it to 99 to match Seth
#define MAX_FRAMES_PER_ABUSED_SEQUENCE 100
#define MAX_SEQUENCES 2000 /* Max # of sprite animations */
...
'special'.  */
	int16_t frame[MAX_FRAMES_PER_ABUSED_SEQUENCE + 1 + 1];
	int16_t delay[MAX_FRAMES_PER_ABUSED_SEQUENCE +
