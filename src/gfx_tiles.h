...
so 128*(41-1)+12*8=4216 indexes used, instead of 12*8*41=3936 */
//yeolde: changed this so that it works properly with the right amount of indices
#define GFX_TILES_NB_SQUARES (128 * (GFX_TILES_NB_SETS))

extern int tiles_fire_flip_range;
extern int tiles_fire_start_sheet;
extern int tiles_water_flip_range;
extern int tiles_water_start_sheet;
