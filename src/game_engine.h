...
extern Uint64 cycle_clock;
extern int timer_fade;
extern int cycle_script;
extern int please_wait_toggle_frame;
extern int customexp;

extern /*bool*/ int screen_main_is_running;

extern Uint64 thisTickCount;
extern Uint64 lastTickCount;
extern Uint64 pauseTickCount;
extern int fps_final;
extern float base_timing;
...
extern Uint64 game_GetTicks(void);
extern void game_set_high_speed(void);
extern void game_set_turbo_speed(void);
extern void game_set_normal_speed(void);
extern void game_set_slow_speed(void);
extern void game_set_extremely_slow_speed(void);
