...
extern int add_text_sprite(char* text, int script, int sprite_owner, int mx,
						int my);
...
int print_text_wrap(char*, rect*, int, int, FONT_TYPE,
					std::vector<TextCommand>* imgs) {
	return 0;
}
int print_text_wrap_getcmds(char* str, rect* box, /*bool*/ int hcenter,
